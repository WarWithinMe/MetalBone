...
namespace MetalBone
{
    namespace CSS
    {
        ...
        struct RenderRuleCacheKey
        {
            ...
            RenderRuleCacheKey& operator=(RenderRuleCacheKey& rhs)
                { styleRules = rhs.styleRules; return *this; }
        };
        ...
        struct BasicSelector
        {
            ...
            BasicSelector():pseudo(0/*PC_Default*/), pseudoCount(0), relationToNext(MatchNextIfAncestor){} 
